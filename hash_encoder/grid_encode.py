...
class GridEncode(Function):
    ...
    def __init__(self, hash_func_header, per_level_scale, n_pos_dims=3, n_features_per_level=2, n_levels=16, base_resolution=16, log2_hashmap_size=19,n_rays_per_batch=4096,MAX_STEP=1024,using_fp16=False,loss_scale=128.0):
